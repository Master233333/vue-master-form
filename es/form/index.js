...
exports.setGetInputs = setGetInputs;
Object.defineProperty(exports, "renderFormItem", {
  enumerable: true,
  get: function get() {
    return _form.renderFormItem;
  }
});
...
function setErrorMessage(errorMsg) {
  if (errorMsg) {
    _config.default.errorMessage = errorMsg || {};
  }
}

function setGetInputs(func) {
  if (func) {
    _config.default.getInputs = func;
  }
}
...
function (_IForm) {
  ...
  _createClass(Form, null, [{
    ...
    value: function install(vue, options) {
      ...
      vue.component('mh-form-item', _formItem.default);
    }
  }]);
